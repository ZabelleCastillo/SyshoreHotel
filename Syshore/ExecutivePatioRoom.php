...
<head>
	<title> Executive Patio Room | SyshoreBeachFront Hotel</title>
...
<body>
	...
	<div id="mainDiv">
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td  width="30%" colspan="2"> <p id="text2">Image </p> <hr width="80%" height="50%" color="blue" align="left"> </hr>   <br><br> <img src="img/tblepix/exec.png" width="100%" height="70%"> </td>
				<td width="30%"> <p id="text2"> Executive Patio Room </p> <hr width="80%" height="50%" color="blue" align="left"> </hr> <br><br>
					<p id="text3">Rooms 102,105 Php2,500.00 a night 
				(1 King and 1 Queen bed, Free breakfast for 2 persons, free bottled water for 2 persons, Air conditioned, private
				bathroom, outside patio, LED TV, refrigerator).
					</p> <br><br><br>
				</td>				
			</tr>
