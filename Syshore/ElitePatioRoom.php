...
<head>
	<title> Elite Patio Room| SyshoreBeachFront Hotel</title>
...
<body>
	...
	<div id="mainDiv">
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td  width="30%" colspan="2"> <p id="text2">Image </p> <hr width="80%" height="50%" color="blue" align="left"> </hr>   <br><br> <img src="img/tblepix/elitepat.png" width="95%" height="65%"> </td>
				
				<td width="30%"> <p id="text2"> Elite Patio Room </p> <hr width="80%" height="50%" color="blue" align="left"> </hr> <br><br>
					<p id="text3">Rooms 103, 104 Php3,000.00 a night 
(2 Queen beds, Free breakfast for 2 persons, free bottled water for 2 persons, Air conditioned, large private bathroom, outside patio, LED TV, refrigerator).
					</p> <br><br><br>
				</td>				
			</tr>
