...
<head>
	<title> Accomodations | SyshoreBeachFront Hotel</title>
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td width="25%"> 
					...
					<img src="img/tblepix/acco.png" width="100%" height="40%"> <br> <br> <br> <br> <br> <br> <br>
				</td>
				<td width="25%" colspan="2"> <p id="text1">Accomodations </p>  <br><p id="text6"> SyshoreBeachFront Hotel is not just perfect for day tours. 
					It has accommodations which you can choose for an overnight stay. <br> <br>
					Missing your own bedroom? Feel the comfort or your own nook in the SyshoreBeachFront Hotel Rooms.  <br><br>
					Or try to experience what it's like to sleep in the very Filipino <br> <br>
					<a href="StandardRoom.php" id="a" style="text-decoration: underline"> Standard Rooms </a>,  <br>
					<a href="SuperiorRoom.php" id="a" style="text-decoration: underline">Superior Rooms  </a>,  <br>
					<a href="ExecutivePatioRoom.php" id="a" style="text-decoration: underline">Executive Patio Rooms  </a>, <br>
					<a href="ElitePatioRoom.php" id="a" style="text-decoration: underline">Elite Patio Rooms  </a> and <br>
					<a href="StudioSuiteRoom.php" id="a" style="text-decoration: underline">Studio Suite Room. </a> <br><br>
					If you are looking for a place to held your much waited event, wether it be a corporate function or family occasion,
					SyshoreBeachFront Hotel can accommodate you and your valued guests in the resort's Function Hall. <br><br>
					Forget all your worries. Spend a night or more in SyshoreBeachFront Hotel.  <br>
				</p> </td>	
			</tr>
