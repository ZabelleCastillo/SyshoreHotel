...
<head>
	<title> Events to Celebrate | SyshoreBeachFront Hotel</title>
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td width="30%" colspan="2"> 
					<p id="text1">Events to Celebrate: </p> 
					 <p id="text6"> Also offers the ultimate atmosphere for meetings, conferences, family reunions, debut, kiddies parties and weddings. <br> <br><br>
					-FUNCTION HALL- <br><br>
					Our function rooms can accommodate special meetings gathering up to 100 guests with flexibility to handle both large and small
						meetings. Our staff serves with gracious hospitality and efficiency to ensure that all your requirements are met. Whether 
						you're a planning with a party, convention or conference, our facilities can accommodate special events of almost any size.
						Our experienced and professional Catering and Convention Services team will help you arrange everything from the menu to 
						the audio-equipment.<br><br><br>
					Other Services:<br><br>
					We provide Catering Services for Company Outings, reunions, Seminars, Birthday and Debut Parties, Wedding, Baptism, Beach 
						Parties and other events.
					</p> 
					</td><br>
				<td width="30%">
					<p id="text1"> Beachside Catering: </p> 
					<img src="img/tblepix/bch2.png" width="100%" height="45%"> 
					<br>
				</td>
				<!--<td width="25%"> 
					<marquee behavior="scroll" direction="up" scrollamount="2" height="90%">  
					<img src="img/tblepix/bch.png" width="100%" height="110">
					<img src="img/tblepix/bch2.png" width="100%" height="110">
					<img src="img/tblepix/bch3.png" width="100%" height="110"> </marquee>
				</td>-->
			</tr>
