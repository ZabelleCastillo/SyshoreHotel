...
<head>
	<title> Superior Room | SyshoreBeachFront Hotel</title>
...
<body>
	...
	<div id="mainDiv">
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td width="30%"> <p id="text2"> Superior Room </p> <hr width="80%" height="50%" color="blue" align="left"> </hr> <br><br>
					<p id="text3"> Rooms 123,127 Php800.00 a night 
					(2 Single bed, Air conditioned, private bathroom, TV)
					</p> <br><br><br>
				</td>
				<td  width="30%" colspan="2"> <p id="text2">Image </p> <hr width="80%" height="50%" color="blue" align="left"> </hr>   <br><br> <img src="img/tblepix/sup.png" width="100%" height="70%"> </td>
			</tr>
