...
<head>
	<title> Standard Room | SyshoreBeachFront Hotel</title>
...
<body>
	...
	<div id="mainDiv">
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td width="30%"> <p id="text2"> Standard Room </p> <hr width="80%" height="50%" color="blue" align="left"> </hr> <br><br>
					<p id="text3"> Room 122, Apt. 2A, 2B, 4A, 4B Php150.00 per head 
					(2 Double Deck, open room up to 4 persons, Fan only and common bathroom) 
					</p> <br>
					 <p id="text3">Rooms 120 and 121 Php200.00 per head 
					(2 Double Deck, open room up to 4 persons,Air conditioned and common bathroom)
					</p><br><br>
				</td>
				<td  width="30%" colspan="2"> <p id="text2">Image </p> <hr width="100%" height="50%" color="blue" align="left"> </hr>   <br><br> <img src="img/tblepix/stan.png" width="100%" height="70%"> </td>
			</tr>
