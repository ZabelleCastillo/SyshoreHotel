...
<head>
	<title> Studio Suite Room| SyshoreBeachFront Hotel</title>
...
<body>
	...
	<nav>
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td  width="30%" colspan="2"> <p id="text2">Image </p> <hr width="80%" height="50%" color="blue" align="left"> </hr>   <br><br> <img src="img/tblepix/studio.png" width="100%" height="60%"> </td>
				
				<td width="30%"> <p id="text2"> Studio Suite Room </p> <hr width="80%" height="50%" color="blue" align="left"> </hr> <br><br>
					<p id="text3"> Room 101 Php3,500.00 a night 
				(2 King beds, Free breakfast for 2 persons, free bottled water for 2 persons, air conditioned, private bathroom with bathtub, LED TV, refrigerator) 
				Extra bed Php 350.00 per night. <br>
				Extra pillow/ towel Php 50.00 </p> <br><br><br>
				</td>				
			</tr>
