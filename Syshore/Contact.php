...
<head>
	<title> Contact Us | SyshoreBeachFront Hotel</title>
		...
		<div id="mainInner"> 
			...
			<div id="Inside-Contactus">
				<div id="contactus">
					...
					<center> <h2 id="h2_contact"><?php if(isset($_GET['sent'])) { echo "Your message has been sent.";} ?></h2> </center> <br>
						<h1>Contact Us</h1>					
						<ul>
							<li>
								<label for="name">Your Name(required)<span id="error"><?php if(isset($_GET['error_name'])) { echo "**Please fill up the fields**"; } ?><span></label>
								<input type="text" name="name" value="">
							</li>
							<li>
								<label for="email">Your Email(required)<span id="error"><?php if(isset($_GET['error_email'])) { echo "**example@yahoo.com**"; } ?><span></label>
								<input type="text" name="email" value="">
							</li>
							<li>
								<label for="subject">Subject<span id="error"><?php if(isset($_GET['error_subject'])) { echo "**example**"; } ?><span></label>
								<input type="text" name="subject" value="">
							</li>
							<li>
								<label>Your Message<span id="error"><?php if(isset($_GET['error_message'])) { echo "**Write message you want**"; } ?><span></label>
...
if($send)
 ...
 {
$insert=mysql_query("INSERT INTO message (name,email,number,message) VALUES ('$name','$email','$num','$message') ");
  }
