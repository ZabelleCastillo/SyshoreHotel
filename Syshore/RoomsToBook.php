...
<head>
	<title> Rooms To Book | SyshoreBeachFront Hotel</title>
...
<body>
	...
	<div id="mainDiv">
		...
		<div id="mainInner"> 	
					 <p id="romsTBok">  Rooms to Book </p> 
					<!--<hr width="85%" id="romsTBok" height="50%" color="blue" align="center"> </hr>-->
	

			<table border="2" id="tble" align="center">				
			<tr>
				<td colspan="2"> 
					Accommodations in resorts are important features to attract guests. Because just like in any other setting, when people get tired 
					of being outdoor, whatever time of the day it is, they will have to have some time to rest. <br> <br>
					Taking a quick snooze will help you boost your system and when you’re up again, it’s time for another dip in the pool or another videoke marathon. <br> <br>
					
					-Standard Room-(Php200.00)<br> 
					
					-Superior Room- (Php800.00)<br>
					
					-Executive Patio Room- (Php2,500.00)<br>
					
					-Elite Patio Room- (Php3,000.00)<br>
					
					-Studio Suite Room- (Php3,500.00)<br>
			<br> <br>
					Who says you can’t achieve relaxation in a room that offers basic amenities? <br><br> Check our
						 <a href="Accomodations.php" id="a" style="text-decoration: underline"> accommodations here. </a> 
					
				</td>
				<td width="30%"> <br> <br> 
					<img src="img/tblepix/roo.png" width="100%" height="70%"> <br> <br> <br> <br>   </td>
			</tr>
