...
<head>
	<title> Getting Here | SyshoreBeachFront Hotel</title>
...
<body>
	...
	<div id="mainDiv">
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td width="5%"> Where we us: <br> <p id="text6"> San Jose, Sogod, Southern Leyte </p> </td>	
				<td width="5%" colspan="2"> Map: <BR> 
				<iframe width="500" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com.ph/maps?f=d&amp;source=s_d&amp;saddr=SeaShore+Resort&amp;daddr=&amp;geocode=FUhkngAdDvdyByEwkLbXlYMctil5t26twREHMzEwkLbXlYMctg&amp;aq=&amp;sll=10.380768,124.975748&amp;sspn=0.008432,0.009645&amp;hl=en&amp;mra=ls&amp;ie=UTF8&amp;t=m&amp;ll=10.380778,124.975748&amp;spn=0.007387,0.010729&amp;z=16&amp;output=embed"></iframe><br /><small><a href="https://www.google.com.ph/maps?f=d&amp;source=embed&amp;saddr=SeaShore+Resort&amp;daddr=&amp;geocode=FUhkngAdDvdyByEwkLbXlYMctil5t26twREHMzEwkLbXlYMctg&amp;aq=&amp;sll=10.380768,124.975748&amp;sspn=0.008432,0.009645&amp;hl=en&amp;mra=ls&amp;ie=UTF8&amp;t=m&amp;ll=10.380778,124.975748&amp;spn=0.007387,0.010729&amp;z=16" style="color:#0000FF;text-align:left">View Larger Map</a></small>
				</td>					
			</tr>
			<tr>
				<td width="5%"> From Manila: <br> <p id="text6"> Flights are available to Tacloban, Leyte throughout the day. From Tacloban
						we can arrange at anytime a transfer to our resort which takes around 3 hours. Take PAL or Cebu Pacific flight to 
						Tacloban City or Ormoc City. You can either take the Syshore or Commercial/Passenger Van from the Airport to 
						Beach Front Hotel. </p>  </td>	
				<td width="5%" colspan="2"> BY PLANE: <BR> 
						&nbsp;&nbsp;&nbsp;<img src="img/tblepix/airplane.png" width="35%" height="30%">
					<p id="text6"> Airlines that service Manila to Tacloban, Leyte: Philippines 
						Airlines ; Cebu Pacific Air ; Air Phil Express ; Zest Air. </p> </td>					
			</tr>
			
			<tr>
				<td width="5%"> From Cebu: <br> <p id="text6"> There are a number of ferry services from Cebu to Leyte ferry terminals in 
						Bato, Hilongos, Ormoc or Maasin. The Roble ferry leaves from pier 3 in Cebu arriving in Hilongos, Leyte and takes 
						around 4 hours. The land transfer to the resort from Hilongos takes around an hour and a half.  </p> </td>	
				<td width="5%" colspan="2"> BY SHIP: <BR> 
						&nbsp;&nbsp;&nbsp;<img src="img/tblepix/boat.png" width="35%" height="30%">
						<p id="text6"> Take the Passenger Ferry to Maasin or Hilongos or Bato,Leyte. You 
						can either take the Syshore or Commercial/Passenger Van from the Port of Maasin or Hilongos or Bato,Leyte to Syshore.</p> </td>					
			</tr>
