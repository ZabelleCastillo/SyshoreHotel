...
<body>
	...
	<div id="mainDiv">
		...
		<!-- Start Slider BODY section -->
			...
			<div class="ws_images">
			<ul>
				<li><img src="img/images/1.jpg" alt="" title="" id="wows1_0"/></li>
				<li><img src="img/images/2.jpg" alt="" title="" id="wows1_1"/></li>
				<li><img src="img/images/3.jpg" alt="" title="" id="wows1_2"/></li>
				<li><img src="img/images/4.jpg" alt="" title="5" id="wows1_3"/></li>
				<li><img src="img/images/5.jpg" alt="" title="" id="wows1_4"/></li>
				<li><img src="img/images/6.jpg" alt="" title="" id="wows1_4"/></li>
				<li><img src="img/images/7.jpg" alt="" title="" id="wows1_4"/></li>
			</ul>
			</div>
			<div class="ws_bullets">
			<div>
			<a href="#" title="Margaux Hall a multi purpose hall. Fully air-conditioned and can accomodate up to 100 persons in a theater style seating."><img src="img/tooltips/1.jpg" alt=""/>1</a>
			<a href="#" title="Live band at the Function Hall last Valentine's day."><img src="img/tooltips/2.jpg" alt=""/>2</a>
			<a href="#" title="view of the beach area"><img src="img/tooltips/3.jpg" alt=""/>3</a>
			<a href="#" title="Panoramic view of the beachfront area."><img src="img/tooltips/4.jpg" alt=""/>4</a>
			<a href="#" title="SyShore Function Hall with a wedding reception set-up."><img src="img/tooltips/5.jpg" alt=""/>5</a>
			<a href="#" title="The Pool @ SyShore BeachFront Hotel"><img src="img/tooltips/6.jpg" alt=""/>6</a>
			<a href="#" title="Te'race Restaurant"><img src="img/tooltips/7.jpg" alt=""/>7</a>
			</div>
			</div>
				<span class="wsl"></span>
		...
		<table border="2" id="tble" align="center">
			<tr>
				<td colspan="3" cellspacing="10%" cellpadding="20%">
					<p id="hometext"> <b>SyshoreBeachFront Hotel </b> is a nice place to go, located at San Jose, Sogod, Southern Leyte. It's a short walk from the town center. </p>
					<br> <hr width="100%" height="50%" color="blue"> </hr> 
				</td>
			</tr>	

			<tr>
				<td width="5%"> &nbsp; <img src="img/tblepix/t1.png" width="90%" height="25%"> <br> <a href="Amenities.php"> <img src="img/tblepix/01.png" id="image"> </a> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/t2.png" width="90%" height="25%"> <br> <a href="RoomsToBook.php"><img src="img/tblepix/02.png" id="image"> </a> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/t3.png" width="90%" height="25%"> <br> <a href="Services.php"> <img src="img/tblepix/03.png" id="image"> </a> </td>					
			</tr>
