...
<head>
	<title> Amenities & Activities | SyshoreBeachFront Hotel</title>
		...
		<div id="mainInner"> 								
			...
			<tr>
				<td width="30%" colspan="3">
					 <p id="text1"> Swimming pool </p> <br><br><br>
					 <p id="text">  Pool games make the water more fun for kids! Find water games and games for the swimming pool 
					to entertain children for hours using our activity finder. Kids love to play games in the pool like sharks & minnows and 
					marco polo - easy to learn and free.
					</p>
				</td>
			</tr>
			<tr>
				<td width="5%"> &nbsp; <img src="img/tblepix/pool1.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/pool2.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/pool3.png" id="image"></td>					
			</tr>
			<tr>
				<td width="30%" colspan="3">
					 <p id="text1"> Function Hall </p> <br><br><br>
					 <p id="text"> Four purpose-built halls can accommodate a wide-range of events - from trade shows to
					heavy machinery and equipment exhibits, from corporate celebrations to major international 
					concerts. Its flexible layout may easily adapt to the individual requirements of each event.
					</p>
				</td>
			</tr>
			<tr>
				<td width="5%"> &nbsp; <img src="img/tblepix/function1.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/function2.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/function3.png" id="image"></td>					
			</tr>
		
			<tr>
				<td width="30%" colspan="3">
					 <p id="text1"> KTV Bar </p> <br><br><br>
					 <p id="text"> KTV bar of SyshoreBeachFront Hotel is the best way to hang out with your accompanies and this one of the most popular forms of
					entertainment. It is also a way to unwind and have fun with your friends, family, etc. Having too much of a good time means getting 
					carried away, forgetting to behave, and ending up spoiling the videoke party.
					</p>
				</td>
			</tr>
			<tr>
				<td width="5%"> &nbsp; <img src="img/tblepix/ktv.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/ktv2.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/ktv3.png" id="image"></td>					
			</tr>
		
			<tr>
				<td width="30%" colspan="3">
					 <p id="text1"> Terace restaurant </p> <br><br><br>
					 <p id="text"> The Terrace and The SyshoreBeachFront Hotel is a good resto because there is a good view and you'll definitely love the
						beautiful view on the beach that makes you relax yourself.
					</p>
				</td>
			</tr>
			<tr>
				<td width="5%"> &nbsp; <img src="img/tblepix/te.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/te2.png" id="image"> </td>	
				<td width="5%"> &nbsp; <img src="img/tblepix/te3.png" id="image"></td>					
			</tr>
